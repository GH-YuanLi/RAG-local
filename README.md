...
- **会话内对话记忆**：同一会话中支持多轮上下文对话，LLM 能记住之前的问题和答案
...
**多轮对话**：同一会话中，系统会自动携带之前的对话历史，让 LLM 能够理解上下文关系。例如可以追问"上文提到的具体是什么"或"请进一步解释"。

**注意**：查询前需先在"文档管理"中上传并索引文档，否则会提示"未找到相关文档内容"。刷新页面会开启新会话，历史对话将重新开始。
